"""
This module provide some tools for drivers.baidu.py.
"""
...
def parse_host_port(endpoint, default_protocol):
    ...
    if parse_result.scheme == libcloud.utils.protocol.HTTP.name:
        protocol = libcloud.utils.protocol.HTTP
        port = libcloud.utils.protocol.HTTP.default_port
    elif parse_result.scheme == libcloud.utils.protocol.HTTPS.name:
        protocol = libcloud.utils.protocol.HTTPS
        port = libcloud.utils.protocol.HTTPS.default_port
    else:
